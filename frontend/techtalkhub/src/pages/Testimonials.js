...
export default function TestimonialsPage() {
  return (
    <div className="bg-background py-20 px-6 md:px-10">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start gap-10">
        
        {/* Left title/description section */}
        <div className="flex-1 space-y-4">
          <h2 className="text-3xl md:text-4xl font-bold text-text font-poppins">
          ...
          <button className="bg-secondary text-white font-bold px-5 py-2 rounded-xl shadow-btn hover:bg-secondary-dark transition">
            View More
          </button>
        </div>
          ...
          {testimonials.map((t, idx) => (
            <div
              ...
              className={`bg-white shadow-card rounded-xl p-6 flex items-start gap-4 relative ${
                idx === 1 ? "border-l-4 border-secondary bg-[#fafafa]" : ""
              }`}
            >
              <img
                src={t.avatar}
